...
class UploadingImageToFirebaseStorage extends StatefulWidget {
  ...
  UploadingImageToFirebaseStorage(this._emailAddress);
  @override
...
class _UploadingImageToFirebaseStorageState
  ...
  Future uploadImageToFirebase(BuildContext context) async {
    ...
    uploadTask.whenComplete(() async {
      ...
      print(url);
      print("Global Data URl:- " + GlobalData.URL);
      GlobalData.URL = url;
      print("New Global Data URl:- " + GlobalData.URL);
      Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => AddDataScreen(widget._emailAddress)));
    }).catchError((onError) {
      print(onError);
    });
    print(url);
